...
contract SafuuXSacrificeERC is Ownable, ReentrancyGuard {
    ...
    function setBonusStart(uint256 timestamp) external onlyOwner {
        bonusStart = timestamp;
    }
    ...
    function getBonusDay() public view returns (uint256) {
        uint256 noOfDays = (block.timestamp - bonusStart) / 86400 + 1;
        return noOfDays;
    }
    ...
    function _init() internal {
        ...
        setAllowedTokens("USDC", 0x92Cdf7Ae7105cCb0827565482ECbdB7338FC7d2d);
        ...
        // setAllowedTokens("WBTC", 0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599);

        setTokenDecimals("BUSD", 1e18);
        setTokenDecimals("USDC", 1e6);
        setTokenDecimals("USDT", 1e6);
    ...
    function activateBonus() public onlyOwner {
        require(
            isBonusActive == false,
